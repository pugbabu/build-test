<script>
  ...
  import _getPlacements from 'ant-design-vue/es/tooltip/placements';
  import PropTypes from 'ant-design-vue/es/_util/vue-types';
  import { hasProp, getComponentFromProp, getClass, getStyle, isValidElement } from 'ant-design-vue/es/_util/props-util';
