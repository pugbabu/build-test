<script>
  ...
  import { Circle } from 'ant-design-vue/es/vc-progress';
  ...
  // 修改2 创建了字体样式（进度）
  var biProgressFont = 'bi-progress_font';
      ...
      if (showInfo) {
        ...
        if (format || progressStatus !== 'exception' && progressStatus !== 'success') {
          ...
          text = h(
            ...
            {
              attrs: {
                src: require('../../styles/common/stateicon/errorbig.svg')
              },
              style: {
                width:'32px',
                height: '32px'
        ...
        /*  text = h(Icon, {
            ...
            //text = h(
             ...
             // {
             //   props: {
              //    iconClass: "progressSuccessBig",
             //     svgStyle:'svg-icon_small'
              //  }
             // }
            //)
          text = h(
            ...
            {
              attrs: {
                src: require('../../styles/common/stateicon/correctbig.svg')
              },
              style: {
                width:'32px',
                height: '32px'
        ...
        progressInfo = h(
          'span',
          // 修改4 替换了加载字体的文本样式，原样式类名为ant-progress-text
          { 'class': biProgressFont, attrs: { title: typeof text === 'string' ? text : undefined }
          },
          [text]
        );
      }
...
<style src="../../styles/components/BiProgress.css">
